/*
* I added all types of events for compatibility and debugging purposes only
* even though the project only uses rich presence.
*/

export const browser = typeof window !== 'undefined';

const keyMirror = <T extends readonly string[]>(arr: T) =>
	Object.fromEntries(arr.map(k => [k, k])) as { [K in T[number]]: K };
...
export type RPCErrorsCode = typeof RPCErrors[keyof typeof RPCErrors];

export type RPCCloseCode = typeof RPCCloseCodes[keyof typeof RPCCloseCodes];
